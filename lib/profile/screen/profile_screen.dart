import 'package:daily_quote_app/authentication/screen/sign_in_screen.dart';
  ...
  Widget _buildMenuItem({required IconData icon, required String title, Color? iconColor, Color? textColor, VoidCallback? onTap}) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          title,
          style: TextStyle(fontSize: 16, color: textColor, fontWeight: textColor != null ? FontWeight.bold : FontWeight.normal),
        ),
